...
import { X, ChevronRight, MousePointerClick, Edit3 } from 'lucide-react';
...
const TOUR_STEPS: TourStep[] = [
  // --- INTRO ---
  {
    ...
    content: "Let's get you set up with your new Daily financial habit.",
  ...
  },
  {
    ...
    content: "Check this every morning. It shows your Daily Limit and how much you have safely left to spend.",
    position: 'bottom',
  },
  {
    targetId: null, // Pointing to the FAB is hard as it doesn't have an ID yet, we should add one or just point generally
    path: '/',
    title: "Quick Add Button",
    content: "See that '+' button in the corner?\n\nUse it to add expenses instantly from ANY page. Try to log expenses as soon as they happen!",
    position: 'right', // Positioning might need adjustment or we give the FAB an ID
  },
  ...
  // --- BUDGET ---
  {
    ...
    content: "Go here to configure your Monthly Budget. We'll automatically calculate your Daily Safe Limit.",
    position: 'right',
    actionHint: "Navigating..."
  },
  ...
  // --- OUTRO ---
  {
    ...
    path: '/',
    title: "You're Ready! 🎓",
    content: "That's it! Keep it simple.\n\n1. Check your Daily Limit.\n2. Add expenses with Quick Add.\n3. Stay in the green!",
...
const TourGuide: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setTargetRect(null); // Reset target when step changes
  ...
  }, [currentStepIndex, isTourActive, step, location.pathname, navigate]);
