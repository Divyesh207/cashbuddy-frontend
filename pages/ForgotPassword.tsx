          ...
          <form onSubmit={handleRequest} className="space-y-4">
            <div>
               ...
               <input
                 ...
                 required
                 className="w-full px-4 py-3 border border-slate-200 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:outline-none transition-all"
                 value={email}
          ...
          <form onSubmit={handleReset} className="space-y-4">
            <div>
               ...
               <input
                 ...
                 placeholder="------"
                 required
                 className="w-full px-4 py-3 border border-slate-200 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:outline-none text-center tracking-[0.5em] font-bold text-xl"
                 value={otp}
            ...
            <div>
               ...
               <input
                 ...
                 placeholder="••••••••"
                 required
                 className="w-full px-4 py-3 border border-slate-200 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:outline-none"
                 value={newPassword}
